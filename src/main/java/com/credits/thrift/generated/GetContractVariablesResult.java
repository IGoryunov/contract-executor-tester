...
public class GetContractVariablesResult implements org.apache.thrift.TBase<GetContractVariablesResult, GetContractVariablesResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetContractVariablesResult> {
  ...
  public java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> contractVariables; // required
  ...
  public GetContractVariablesResult(
    APIResponse status,
    java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> contractVariables)
  {
    this();
    this.status = status;
  ...
  public GetContractVariablesResult(GetContractVariablesResult other) {
    ...
    if (other.isSetContractVariables()) {
      java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> __this__contractVariables = new java.util.HashMap<java.lang.String,com.credits.thrift.generated.Variant>(other.contractVariables.size());
      for (java.util.Map.Entry<java.lang.String, com.credits.thrift.generated.Variant> other_element : other.contractVariables.entrySet()) {

        java.lang.String other_element_key = other_element.getKey();
        com.credits.thrift.generated.Variant other_element_value = other_element.getValue();

        java.lang.String __this__contractVariables_copy_key = other_element_key;

        com.credits.thrift.generated.Variant __this__contractVariables_copy_value = new com.credits.thrift.generated.Variant(other_element_value);
  ...
  public GetContractVariablesResult setStatus(APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public void putToContractVariables(java.lang.String key, com.credits.thrift.generated.Variant val) {
    if (this.contractVariables == null) {
      this.contractVariables = new java.util.HashMap<java.lang.String,com.credits.thrift.generated.Variant>();
    }
    this.contractVariables.put(key, val);
  }

  public java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> getContractVariables() {
    return this.contractVariables;
  }

  public GetContractVariablesResult setContractVariables(java.util.Map<java.lang.String,com.credits.thrift.generated.Variant> contractVariables) {
    this.contractVariables = contractVariables;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CONTRACT_VARIABLES:
      if (value == null) {
        ...
        setContractVariables((java.util.Map<java.lang.String,com.credits.thrift.generated.Variant>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.contractVariables = new java.util.HashMap<java.lang.String,com.credits.thrift.generated.Variant>(2*_map24.size);
                java.lang.String _key25;
                com.credits.thrift.generated.Variant _val26;
                for (int _i27 = 0; _i27 < _map24.size; ++_i27)
                {
                  _key25 = iprot.readString();
                  _val26 = new com.credits.thrift.generated.Variant();
                  _val26.read(iprot);
                  struct.contractVariables.put(_key25, _val26);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetContractVariablesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.contractVariables != null) {
        oprot.writeFieldBegin(CONTRACT_VARIABLES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.thrift.generated.Variant> _iter28 : struct.contractVariables.entrySet())
          {
      ...
      if (struct.isSetContractVariables()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, com.credits.thrift.generated.Variant> _iter29 : struct.contractVariables.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.contractVariables = new java.util.HashMap<java.lang.String,com.credits.thrift.generated.Variant>(2*_map30.size);
          java.lang.String _key31;
          com.credits.thrift.generated.Variant _val32;
          for (int _i33 = 0; _i33 < _map30.size; ++_i33)
          {
            _key31 = iprot.readString();
            _val32 = new com.credits.thrift.generated.Variant();
            _val32.read(iprot);
            struct.contractVariables.put(_key31, _val32);
          }
        }
        struct.setContractVariablesIsSet(true);
      }
