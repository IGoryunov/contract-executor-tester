...
public class GetContractMethodsResult implements org.apache.thrift.TBase<GetContractMethodsResult, GetContractMethodsResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetContractMethodsResult> {
  ...
  public GetContractMethodsResult setStatus(APIResponse status) {
    this.status = status;
    return this;
  }
  ...
  public GetContractMethodsResult setMethods(java.util.List<MethodDescription> methods) {
    this.methods = methods;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.methods = new java.util.ArrayList<MethodDescription>(_list16.size);
                MethodDescription _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new MethodDescription();
                  _elem17.read(iprot);
                  struct.methods.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetContractMethodsResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.methods != null) {
        oprot.writeFieldBegin(METHODS_FIELD_DESC);
        {
          ...
          for (MethodDescription _iter19 : struct.methods)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetMethods()) {
        {
          ...
          for (MethodDescription _iter20 : struct.methods)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.methods = new java.util.ArrayList<MethodDescription>(_list21.size);
          MethodDescription _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new MethodDescription();
            _elem22.read(iprot);
            struct.methods.add(_elem22);
          }
        }
        struct.setMethodsIsSet(true);
      }
